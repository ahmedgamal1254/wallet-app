    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="{{ route('admin.login') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" value="{{ old('email') }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
                @error('email')
